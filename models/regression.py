...
if __name__ == "__main__":
    ...
    #     [Predictions, SPost, accuracy] = ML.binaryRegression(train_att, train_label, l, test_att, test_labels)
    ...
    #         [_, SPost, accuracy] = ML.binaryRegression(reduced_train, train_label, l, reduced_test, test_labels)
    #         [Predictions, _] = ML.calculate_model(SPost, test_att, "Regression", priorProb, test_labels)
    #         confusion_matrix = ML.ConfMat(Predictions, test_labels)
    #         DCF, DCFnorm = ML.Bayes_risk(confusion_matrix, pi, Cfn, Cfp)
    #         (minDCF, _, _) = ML.minCostBayes(SPost, test_labels, pi, Cfn, Cfp)
    ...
    #             [_, SPost, accuracy] = ML.binaryRegression(LDA_train, train_label, l, LDA_test, test_labels)
    #             [Predictions, _] = ML.calculate_model(SPost, test_att, "Regression", priorProb, test_labels)
    #             confusion_matrix = ML.ConfMat(Predictions, test_labels)
    #             DCF, DCFnorm = ML.Bayes_risk(confusion_matrix, pi, Cfn, Cfp)
    #             (minDCF, _, _) = ML.minCostBayes(SPost, test_labels, pi, Cfn, Cfp)
